...
// 获取项目列表信息
export const projects_list = params => { return axios.get(`${host}/projects/?page=` + params.page + '&size=' + params.size + '&ordering=-create_time') };
...
// 获取内置函数列表信息
export const builtins_list = params => { return axios.get(`${host}/debugtalks/?page=` + params.page + '&size=' + params.size + '&ordering=-create_time') };
...
// 获取接口列表信息
export const interfaces_list = params => { return axios.get(`${host}/interfaces/?page=` + params.page + '&size=' + params.size + '&ordering=-create_time') };
...
// 获取套件列表信息
export const testsuites_list = params => { return axios.get(`${host}/testsuits/?page=` + params.page + '&size=' + params.size + '&ordering=-create_time') };
...
// 获取用例列表信息
export const testcases_list = params => { return axios.get(`${host}/testcases/?page=` + params.page + '&size=' + params.size + '&ordering=-create_time') };
...
// 获取测试报告列表信息
export const reports_list = params => { return axios.get(`${host}/reports/?page=` + params.page + '&size=' + params.size + '&ordering=-create_time') };
...
// 获取配置列表信息
export const configures_list = params => { return axios.get(`${host}/configures/?page=` + params.page + '&size=' + params.size + '&ordering=-create_time') };
...
// 获取环境列表信息
export const envs_list = params => { return axios.get(`${host}/envs/?page=` + params.page + '&size=' + params.size + '&ordering=-create_time') };
